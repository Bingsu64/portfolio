# Project HELVETIA
I designed and validated the auxiliary recovery PCB for Project HELVETIA responsible for power distribution, deployment actuation, and servo PWM generation for the recovery system.
...
| :--: |
| *Figure 2: Render of the Recovery Section of the rocket* |

After apogee detection, the drogue parachute is deployed by CO2 separation of the nosecone. This is actuated by solenoid valves powered through switching MOSFET's on the PCB.
For the main parachute deployment, servo motors are controlled to pull open a snap shackle mechanism. They are controlled by a PWM signal generated by the board.
...
| :--: |
| *Figure 3: COTS flight computer telemetry data of the flight during the SACUP competition* |
